...
CONTINPath='/Users/aljosha/stack/PCC-PhD/Scripts/pyCONTIN/exec/contin'
...
def readblock(fileObj):
   ...
   28/02/2017 Aljosha:
   A block is terminated by either of the REs q, r, etcetera. Add more whenever necessary.
    """
    data=[]
